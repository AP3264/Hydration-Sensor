       ...
       # self.com = "/dev/cu.usbmodem144302"
        ...
        arduino_ports = [
           ...
           for p in serial.tools.list_ports.comports()
               ...
               if "mEDBG CMSIS-DAP" in p.description
       ]
...
#        self.img_label.pack()
        ...
        # Log Button
        self.log_button = Button(master, text="Log Data", command=self.log_data, highlightbackground = 'chartreuse3',width=20)
        self.log_button.config(font=('Helvetica',12, 'bold'))
        self.log_button.pack(pady=5)
        
        # Plot Button
        self.plot_button = Button(master, text="Plot Graph", highlightbackground = 'azure',command=self.plotGraph,width=20)
        self.plot_button.config(font=('Helvetica',12, 'bold'))
        self.plot_button.pack(pady=5)
        
        # Live Plot
        self.live_plot_button = Button(master, text="Live Plot", highlightbackground = 'blue',command=self.LivePlot,width=20)
        self.live_plot_button.config(font=('Helvetica',12, 'bold'))
        self.live_plot_button.pack(pady=5)
        
        # Select Files to Plot
        self.file_select = Button(master, text="Select up to 4 Files to Plot", highlightbackground = 'orange', command=self.plotSelectedGraph, width=20)
        self.file_select.config(font=('Helvetica',12, 'bold'))
        self.file_select.pack(pady=5)

        # Close out GUI
        self.close_button = Button(master, text="Close", command=master.quit, highlightbackground='orangered2', width=20)
